    ...
    <table cellspacing="9px" id="ken_table" width="32%">
        <tr>
            <td>         
                ...
                <asp:TextBox width="100%" ID="txtEmail" placeholder="Email Address" runat="server"  BackColor="White" BorderColor="#3A5795" ForeColor="Black"></asp:TextBox>
        ...
        <tr>
            <td>
                ...
                <asp:TextBox width="100%" ID="txtPassword" placeholder="*******" runat="server" TextMode="Password"  BackColor="White" BorderColor="#3A5795" ></asp:TextBox>
