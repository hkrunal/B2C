...
<br />
    ...
    <asp:DataList ID="dlProducts" runat="server" RepeatDirection="Horizontal" RepeatColumns="5" OnItemCommand="dlProducts_ItemCommand" Font-Names="Verdana" Font-Size="Small" Width="600px">
        <ItemStyle ForeColor="Black"/>
        <ItemTemplate >
            <div id="pricePlans" style="margin-left:30px">
                <ul id="plans">
                    <li class="plan">
                        <ul class="planContainer">
                            <li class="button">
                                <asp:LinkButton ID="lnkProduct" runat="server" Text="Choose Here" CommandArgument='<%#Eval("productid")%>'>
                                </asp:LinkButton>
                            </li>
                            <li class="title">
